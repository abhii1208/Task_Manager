    ...
    <div className="min-h-screen bg-page-bg">
      <div className="grid min-h-screen lg:grid-cols-2">
        <section className="relative hidden overflow-hidden bg-[#2f2aa8] lg:flex">
          ...
          <div className="relative z-10 flex min-h-full w-full flex-col px-12 py-12 xl:px-16 xl:py-14">
            <div className="flex items-center gap-3">
              ...
              <p className="text-[26px] font-bold tracking-tight text-white">TaskFlow Pro</p>
            </div>

            <div className="mt-16 max-w-[560px]">
              <h1 className="text-5xl font-extrabold leading-[1.08] tracking-[-0.02em] text-white xl:text-[72px]">
                Master your
                <br />
                workflow with
                <br />
              ...
              <div className="mt-10 space-y-5">
                {featureItems.map((item) => (
                  <div
                    key={item.title}
                    className="rounded-2xl border border-white/25 bg-white/12 px-6 py-5 backdrop-blur-md"
                  >
                    <div className="flex items-start gap-3">
                      <span className="mt-1 text-white">{item.icon}</span>
                      <div>
                        <h3 className="text-xl font-semibold text-white">{item.title}</h3>
                        <p className="mt-1 text-base text-indigo-100/95">{item.description}</p>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <section className="flex items-center justify-center bg-[#f8f7ff] px-4 py-10 sm:px-8">
          <div className="w-full max-w-[560px]">
            <div className="mb-8 lg:hidden">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-brand text-white shadow-soft">
                <CheckCircle2 size={23} />
              </div>
              <p className="mt-3 text-2xl font-extrabold tracking-tight text-brand">TaskFlow Pro</p>
            </div>

            <h1 className="text-3xl font-extrabold tracking-[-0.02em] text-text-main sm:text-4xl lg:text-[30px]">{title}</h1>
